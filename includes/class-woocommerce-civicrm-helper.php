 ...
 class Woocommerce_CiviCRM_Helper {
  ...
  public $civicrm_states = array();
 	...
 	public function __construct(){
 		...
 		$this->civicrm_states = $this->set_civicrm_states();
  ...
  private function set_civicrm_states(){
    ...
    while( $dao->fetch() ){
      $this->civicrm_states[$dao->id] = array(
        'id' => $dao->id,
        'name' => $dao->name,
